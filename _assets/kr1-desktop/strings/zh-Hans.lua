...
local kr1 = {
    ...
    ENDLESS_REWARD_ARCHER_BLEED = string.format("弓箭塔的流血伤害提升%d%%", endless.friend_buff.archer_bleed * 10),
    ENDLESS_REWARD_ARCHER_MULTISHOT = string.format("弓箭塔普攻额外发射一支箭矢"),
    ENDLESS_REWARD_ARCHER_INSIGHT = string.format("弓箭命中敌人额外提升敌人易伤%d%%", endless.friend_buff.archer_insight),
