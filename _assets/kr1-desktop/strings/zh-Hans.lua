...
local kr1 = {
    ...
    ENDLESS_REWARD_HEALTH = string.format("友方单位生命值提升%d%%", endless.friend_buff.s_health_factor),
    ENDLESS_REWARD_SOLDIER_DAMAGE = string.format("友方士兵伤害提升%d%%",endless.friend_buff.s_soldier_damage_factor),
    ENDLESS_REWARD_SOLDIER_COOLDOWN = string.format("友方士兵攻速提升%d%%", endless.friend_buff.s_soldier_cooldown_factor),
    ENDLESS_REWARD_TOWER_DAMAGE = string.format("防御塔伤害增加%d%%",endless.friend_buff.s_tower_damage_factor),
    ENDLESS_REWARD_TOWER_COOLDOWN = string.format("防御塔攻速提升%d%%", endless.friend_buff.s_tower_cooldown_factor),
    ENDLESS_REWARD_HERO_DAMAGE = string.format("英雄伤害提升%d%%", endless.friend_buff.s_hero_damage_factor),
    ENDLESS_REWARD_HERO_COOLDOWN = string.format("英雄攻速提升%d%%", endless.friend_buff.s_hero_cooldown_factor),
    ENDLESS_REWARD_ARCHER_BLEED = string.format("弓箭塔的流血伤害提升%d%%", endless.friend_buff.archer_bleed * 1000),
    ENDLESS_REWARD_ARCHER_MULTISHOT = string.format("弓箭塔普攻额外发射一支箭矢"),
    ENDLESS_REWARD_ARCHER_INSIGHT = string.format("弓箭命中敌人额外提升敌人易伤%d%%", endless.friend_buff.archer_insight * 100),
    ENDLESS_REWARD_ARCHER_CRITICAL = string.format("提升弓箭的暴击率%d%%",endless.friend_buff.archer_critical * 100),
    ENDLESS_REWARD_RAIN_COUNT_INC = string.format("火雨数量提升%d颗", endless.friend_buff.rain_count_inc),
    ENDLESS_REWARD_RAIN_DAMAGE_INC = string.format("火雨伤害提升%d%%", endless.friend_buff.rain_damage_inc),
    ENDLESS_REWARD_RAIN_RADIUS_MUL = string.format("火雨范围提升%d%%", (endless.friend_buff.rain_radius_mul-1) * 100),
    ENDLESS_REWARD_RAIN_COOLDOWN_DEC = string.format("火雨冷却时间减少%d秒", endless.friend_buff.rain_cooldown_dec),
...
local kr5 = {
    ...
    TOWER_TRICANNON_4_BOMBARDMENT_2_DESCRIPTION = string.format("扩大范围，发射更多炸弹，每枚造成%s-%s点物理伤害。",balance.towers.tricannon.bombardment.damage_min[2],balance.towers.tricannon.bombardment.damage_max[2]),
    ENEMY_DARKSTEEL_SHIELDER_EXTRA = "- 被击败后变成锤兵",
    SOLDIER_STAGE_10_YMCA_POLICIA_NAME = "维克多",
    heroes_visual_learning_NAME = "并肩作战",
    TOWER_TRICANNON_4_BOMBARDMENT_3_DESCRIPTION = string.format("扩大范围，发射超多炸弹，每枚造成%s-%s点物理伤害。",balance.towers.tricannon.bombardment.damage_min[3],balance.towers.tricannon.bombardment.damage_max[3]),
    ...
    TOWER_TRICANNON_4_OVERHEAT_1_DESCRIPTION = string.format("每隔%s秒，加农炮进入过载状态%s秒，使炸弹灼烧地面，对敌人每秒造成%s点真实伤害，持续%s秒。",balance.towers.tricannon.overheat.cooldown[1],balance.towers.tricannon.overheat.duration[1],balance.towers.tricannon.overheat.decal.effect.s_damage, balance.towers.tricannon.overheat.decal.effect.duration),
    ...
    TOWER_TRICANNON_4_OVERHEAT_2_DESCRIPTION =string.format(
    "每隔%s秒，加农炮进入过载状态%s秒，使炸弹灼烧地面，对敌人每秒造成%s点真实伤害，持续%s秒。",
    balance.towers.tricannon.overheat.cooldown[2], balance.towers.tricannon.overheat.duration[2],
    balance.towers.tricannon.overheat.decal.effect.s_damage, balance.towers.tricannon.overheat.decal.effect.duration),
    ...
    TOWER_TRICANNON_4_OVERHEAT_3_DESCRIPTION = string.format(
    "每隔%s秒，加农炮进入过载状态%s秒，使炸弹灼烧地面，对敌人每秒造成%s点真实伤害，持续%s秒。",
    balance.towers.tricannon.overheat.cooldown[3], balance.towers.tricannon.overheat.duration[3],
    balance.towers.tricannon.overheat.decal.effect.s_damage, balance.towers.tricannon.overheat.decal.effect.duration),
    ...
    TOWER_TRICANNON_4_BOMBARDMENT_1_DESCRIPTION = string.format("在大范围内迅速发射多枚炸弹，每枚造成%s-%s点物理伤害。",balance.towers.tricannon.bombardment.damage_min[1],balance.towers.tricannon.bombardment.damage_max[1]),
