...
local kr1 = {
    ...
    ENDLESS_MODE_REWARD_HERO_DAMAGE = string.format("英雄伤害提升%d%%", endless.friend_buff.s_hero_damage_factor),
    ENDLESS_MODE_REWARD_HERO_COOLDOWN = string.format("英雄攻速提升%d%%", endless.friend_buff.s_hero_cooldown_factor),
