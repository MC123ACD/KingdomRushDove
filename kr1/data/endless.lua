...
local key_desc_map = {
    ...
    rain_damage_inc = string.format("火雨伤害提升%d点，焦土伤害提升%d点，闪电伤害提升%d点",
        endless.friend_buff.rain_damage_inc, endless.friend_buff.rain_damage_inc * 0.1, endless.friend_buff.rain_damage_inc * 0.5),
