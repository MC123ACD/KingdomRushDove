-- chunkname: @./kr3/data/waves/level10_waves_campaign.lua
			...
			waves = {
				{
					delay = 0,
					path_index = 4,
					notification = "TOWER_ROCK_THROWER_ENTWOOD",
					spawns = {
						{
							interval = 0,
							max_same = 0,
