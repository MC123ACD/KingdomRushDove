-- chunkname: @./kr1/data/levels/level26_data.lua
...
return {
	...
	entities_list = {
		...
		{
			["render.sprites[1].sort_y"] = 305,
			template = "decal_background",
			["render.sprites[1].z"] = 3000,
			["render.sprites[1].name"] = "stage_26_0002",
			pos = {
				x = 512,
				y = 384
			}
		},
		{
			...
			["render.sprites[1].name"] = "stage_26",
			pos = {
				x = 512,
				y = 384
			}
		...
		{
			["render.sprites[1].sort_y"] = 46,
			template = "decal_background",
			["render.sprites[1].z"] = 3000,
			["render.sprites[1].name"] = "stage_26_0003",
			pos = {
				x = 512,
				y = 384
			}
		...
		{
			["delayed_play.min_delay"] = 0,
			["render.sprites[1].r"] = -0.29670597283903605,
		...
		{
			["delayed_play.min_delay"] = 0,
			["render.sprites[1].r"] = -0.17453292519943295,
			template = "decal_blackburn_waves",
			["delayed_play.max_delay"] = 1,
			pos = {
				x = 216,
		...
		},
		{
			["render.sprites[1].z"] = 1400,
			template = "decal_blackburn_weed",
			["render.sprites[1].r"] = 6.283185307179586,
		...
		},
		{
			["tower.holder_id"] = "1",
			["tower.terrain_style"] = 8,
			template = "tower_sorcerer",
			["editor.game_mode"] = 3,
			["powers.polymorph.level"] = 1,
			["ui.nav_mesh_id"] = "1",
			pos = {
				x = 746,
				y = 391
