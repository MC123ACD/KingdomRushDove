...
return function()
    ...
    tt.hero.skills.astral_reflection.hr_cost = {3, 2, 1}
    ...
    tt.hero.skills.black_aegis.hr_cost = {1, 1, 1}
    ...
    tt.hero.skills.void_rift.hr_cost = {3, 3, 3}
    ...
    tt.hero.skills.spatial_distortion.hr_cost = {2, 2, 2}
