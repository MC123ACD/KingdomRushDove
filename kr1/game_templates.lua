...
tt.hero.level_stats.regen_health = {18, 20, 21, 22, 23, 25, 26, 27, 28, 30}
...
tt.hero.skills.sharp_claws.hr_cost = {3, 3, 3}
...
tt.hero.skills.kings_roar.hr_cost = {2, 2, 2}
...
tt.hero.skills.lions_fur.hr_cost = {1, 1, 1}
...
tt.hero.skills.grievous_bites.hr_cost = {1, 2, 3}
...
tt.can_fire_fn = scripts.hero_bruce_ultimate.can_fire_fn
tt.cooldown = 45
...
tt.modifier.use_mod_offset = false
tt.modifier.mod_type = MOD_TYPE_STUN
